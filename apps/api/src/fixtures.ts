...
const transactionsByBusiness: Record<string, TransactionToReview[]> = {
  biz_acme: [
    ...
    },
    {
      ...
      account_name: "Checking",
      business_id: "biz_acme",
      transaction_id: "txn_acme_3",
      category_split: [
        { category: "Office Supplies", amount: 40 },
        { category: "Software", amount: 24.5 },
      ],
      total_amount: 64.5,
      date: "2026-08-19T11:15:00.000Z",
      vendor_id: "vnd_staples",
      vendor_name: "Staples",
      description: "Mixed office + license purchase",
      needs_client_review: false,
    },
    {
      account_id: "acct_checking",
    ...
    },
    {
      ...
      account_name: "Checking",
      business_id: "biz_acme",
      transaction_id: "txn_acme_2b",
      category_split: [],
      total_amount: -120,
      date: "2026-08-18T09:00:00.000Z",
      vendor_name: "",
      paired_transaction_id: "txn_acme_2",
      description: "Monthly compute offset",
      needs_client_review: true,
    },
  ],
  biz_globex: [
